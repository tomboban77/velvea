...
export default async function BuilderPage() {
  ...
  return (
    <>
      ...
      <BuilderManager
        containers={containers.map((c) => ({ id: c.id, name: asL(c.name), priceCents: c.priceCents, imageUrl: c.imageUrl, imagePublicId: c.imagePublicId, capacity: c.capacity, position: c.position, active: c.active }))}
