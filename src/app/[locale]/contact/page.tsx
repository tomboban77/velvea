    ...
    <div className="container-x max-w-4xl py-14">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <a href={`mailto:${s.contact.email}`} className="flex items-center gap-4 rounded-2xl border border-line bg-shell p-5 card-hover">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-iris-soft"><Mail className="h-5 w-5 text-teal-deep" /></span>
        ...
        <a href={`tel:${s.contact.phone}`} className="flex items-center gap-4 rounded-2xl border border-line bg-shell p-5 card-hover">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-iris-soft"><Phone className="h-5 w-5 text-teal-deep" /></span>
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-line bg-shell p-5">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-iris-soft"><MapPin className="h-5 w-5 text-teal-deep" /></span>
        ...
        <div className="flex items-center gap-4 rounded-2xl border border-line bg-shell p-5">
          <span className="flex h-11 w-11 items-center justify-center rounded-full bg-iris-soft"><Clock className="h-5 w-5 text-teal-deep" /></span>
